...
Extracted from 459 of 466 JDs with an archived JD text file (one JD in the corpus has a classification record but no archived raw text, so it's excluded from this denominator entirely): 353 parsed directly (markdown headings, plain-text sections, or condensed paragraph summaries), 106 recovered via LLM interpretation of prose that had no cleanly-parseable structure (see responsibility_bullets_llm.json). 7 JDs have no extractable responsibilities at all — the source scrape is a thin listing stub with zero role-content (verified by direct read, not assumed). Regenerate with `python3 analysis/responsibility_taxonomy.py`.

Classification is rule-based keyword matching (see `responsibility_taxonomy.py::TAXONOMY`), not per-line LLM judgment — treat this as a directional map, not a precise census. Of 3214 extracted bullets, 2756 (85.7%) matched at least one theme; 458 (14.3%) matched none (miscellaneous duties too specific/rare to warrant their own theme — not a sign of missing bullets). A bullet can match more than one theme, so theme percentages sum to well over 100%. Each bullet's extraction source (`regex` vs `llm_interpreted`) is recorded per-JD in responsibility_bullets.json.
...
|---|---|---|---|
| Stakeholder Collaboration & Requirements | 78.9% | 362 | 662 |
| Data Modeling & Transformation | 78.2% | 359 | 776 |
| Data Quality & Testing | 68.4% | 314 | 514 |
| BI & Reporting/Dashboards | 67.8% | 311 | 640 |
| Governance & Documentation | 60.6% | 278 | 416 |
| Pipeline Engineering & Orchestration | 59.0% | 271 | 392 |
| Data Infrastructure & Warehouse Ops | 52.3% | 240 | 375 |
| Architecture & Platform Strategy | 49.0% | 225 | 338 |
| Business Analysis & Insight Generation | 48.4% | 222 | 381 |
| Performance & Cost Optimization | 45.1% | 207 | 294 |
| Self-Service Enablement & Data Literacy | 34.0% | 156 | 199 |
| AI & Agentic Workflows | 30.3% | 139 | 195 |
| Data Ownership (end-to-end) | 30.3% | 139 | 182 |
| Mentorship & Leadership | 13.5% | 62 | 72 |
| Security, Privacy & Risk | 13.1% | 60 | 73 |
| Vendor & Tooling Evaluation | 3.3% | 15 | 17 |
...
### Data Modeling & Transformation — 78.2% of JDs
...
### Data Quality & Testing — 68.4% of JDs
...
### BI & Reporting/Dashboards — 67.8% of JDs
...
### Governance & Documentation — 60.6% of JDs
...
### Pipeline Engineering & Orchestration — 59.0% of JDs
...
### Architecture & Platform Strategy — 49.0% of JDs
...
### Business Analysis & Insight Generation — 48.4% of JDs
...
### Performance & Cost Optimization — 45.1% of JDs
...
### Self-Service Enablement & Data Literacy — 34.0% of JDs
...
### Data Ownership (end-to-end) — 30.3% of JDs
...
### Mentorship & Leadership — 13.5% of JDs
...
### Security, Privacy & Risk — 13.1% of JDs
...
|---|---|---|---|---|
| AI & Agentic Workflows | ai_role | 0.66 | p<0.0001 | 415 |
| Data Quality & Testing | testing_framing | 0.52 | p<0.0001 | 415 |
| Data Ownership (end-to-end) | autonomy_level | 0.31 | p<0.0001 | 415 |
| Security, Privacy & Risk | loss_aversion_framing | 0.30 | p<0.0001 | 415 |
| Data Modeling & Transformation | has_dbt | 0.28 | p<0.0001 | 415 |
| BI & Reporting/Dashboards | has_power_bi | 0.20 | p<0.0001 | 415 |
| Security, Privacy & Risk | domain_risk | 0.17 | p=0.002 | 415 |
| Pipeline Engineering & Orchestration | has_airflow | 0.11 | p=0.02 | 415 |
| BI & Reporting/Dashboards | has_looker | 0.11 | p=0.02 | 415 |
| BI & Reporting/Dashboards | has_tableau | 0.04 | p=0.48 | 415 |
...
| Theme | Dimension | V | p | n |
|---|---|---|---|---|
| Governance & Documentation | testing_framing | 0.35 | p<0.0001 | 415 |
| Governance & Documentation | loss_aversion_framing | 0.32 | p<0.0001 | 415 |
| Data Quality & Testing | loss_aversion_framing | 0.30 | p<0.0001 | 415 |
| Data Modeling & Transformation | testing_framing | 0.29 | p<0.0001 | 415 |
| AI & Agentic Workflows | autonomy_level | 0.23 | p<0.0001 | 415 |
| Data Infrastructure & Warehouse Ops | jd_authorship | 0.23 | p<0.0001 | 415 |
| Data Ownership (end-to-end) | has_power_bi | 0.23 | p<0.0001 | 415 |
| Mentorship & Leadership | autonomy_level | 0.22 | p<0.0001 | 415 |
| Data Modeling & Transformation | loss_aversion_framing | 0.21 | p<0.001 | 415 |
| AI & Agentic Workflows | greenfield_vs_fix | 0.21 | p<0.001 | 415 |
| Data Quality & Testing | stakeholder_orientation | 0.20 | p=0.002 | 415 |
| Data Quality & Testing | jd_authorship | 0.20 | p<0.001 | 415 |
| Governance & Documentation | stakeholder_orientation | 0.20 | p=0.002 | 415 |
| Self-Service Enablement & Data Literacy | has_looker | 0.19 | p<0.0001 | 415 |
| Data Modeling & Transformation | jd_authorship | 0.19 | p<0.001 | 415 |
| Data Ownership (end-to-end) | jd_authorship | 0.19 | p<0.001 | 415 |
| Data Infrastructure & Warehouse Ops | stakeholder_orientation | 0.18 | p=0.008 | 415 |
| Data Ownership (end-to-end) | greenfield_vs_fix | 0.17 | p=0.002 | 415 |
| Performance & Cost Optimization | data_team_maturity | 0.17 | p=0.002 | 415 |
| Data Infrastructure & Warehouse Ops | has_dbt | 0.17 | p<0.001 | 415 |
...
**Mentorship & Leadership × autonomy_level** — χ²=20.86, p<0.0001, V=0.224, n=415

- Overall: execution: 6% (n=121); mixed: 12% (n=161); strategic: 26% (n=133)
- Within seniority=mid: execution: 3% (n=79); mixed: 10% (n=98); strategic: 8% (n=37)
- Within seniority=senior: execution: 13% (n=31); mixed: 13% (n=53); strategic: 22% (n=77)
- **Verdict:** survives the stratification check — the gradient holds within each stratum, not just across the whole corpus.

**Data Infrastructure & Warehouse Ops × jd_authorship** — χ²=21.75, p<0.0001, V=0.229, n=415

- Overall: hiring_manager: 57% (n=302); mixed: 46% (n=83); recruiter: 13% (n=30)
...
**Architecture & Platform Strategy × work_arrangement** — unstratified: χ²=5.88, p=0.12, V=0.119, n=415. Overall: hybrid: 53% (n=197); remote: 46% (n=39); onsite: 30% (n=23); not_stated: 44% (n=156)
...
- Within data_team_maturity=early: hybrid: 42% (n=26); remote: 22% (n=9); onsite: 40% (n=10); not_stated: 50% (n=20)
- Within data_team_maturity=mid: hybrid: 49% (n=118); remote: 54% (n=26); onsite: 20% (n=10); not_stated: 38% (n=94)
- Within data_team_maturity=mature: hybrid: 66% (n=53); remote: 50% (n=4); onsite: 33% (n=3); not_stated: 52% (n=42)
