# Analytics Engineer — This Is Global
...
Analytics Engineer at This Is Global
...
Application Deadline: August 14, 2026 (29 days left to apply)

Job Requisition ID: R0009494
...
*3-run LLM consistency check: `../../analysis/jd_traces/2026-07-15_thisisglobal_analytics-engineer-london.md` (generated by `classify_jds.py`, may not exist yet)*

**velocity_vs_rigour:** rigour — Rigour-focused: 25% of role is testing/documentation ownership with explicit standards for schema, business rules, and metric validation.

**domain_risk:** moderate — Moderate: media company without explicit financial/regulatory language, though works with large diverse datasets.

**collaboration_width:** 4 — named teams: Data Engineering; Analytics teams; Product; Data Science; commercial stakeholders

**data_team_maturity:** mid — Named tools in responsibilities (dbt, Snowflake, Airflow), dedicated data team with multiple specialties, growing analytics function.

**jd_authorship:** hiring_manager — Hiring manager: precise methodology (semantic layers, core entities, curated datasets) and clear application context (BI, product, data science).

**stakeholder_orientation:** internal_data — Focus on building shared metrics and trusted data products for internal BI, Data Science, and Analytics teams—not external commercial.

**autonomy_level:** strategic — Strategic: end-to-end product ownership and domain expertise development, not just executing on specs.

**greenfield_vs_fix:** fix_scale — Fix/scale: transforming existing raw data structures into curated products, improving quality and consistency.

**urgency:** urgent — Posted Today; End Date: August 14, 2026 (29 days left to apply)
...
**loss_aversion:** Build trusted, reusable data products with clear, consistent definitions and metrics; automated checks for accuracy — preventing bad data reaching decision-makers.
