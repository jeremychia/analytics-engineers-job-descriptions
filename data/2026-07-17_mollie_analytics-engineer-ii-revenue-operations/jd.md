# Analytics Engineer II - Revenue Operations — Mollie

**URL:** https://jobs.ashbyhq.com/mollie/e6f792da-14d3-4a60-8e33-96700f00006f
...
*3-run LLM consistency check: `../../analysis/jd_traces/2026-07-17_mollie_analytics-engineer-ii-revenue-operations.md` (generated by `classify_jds.py`, may not exist yet)*

**velocity_vs_rigour:** velocity — Multiple velocity phrases ("Always Be Shipping", "fast-moving", "move faster", "priorities shift and ambiguity is part of the job") dominate with no testing/governance/compliance signals, giving velocity.

**domain_risk:** moderate — Errors affect commercial decision-making (lead assignment, performance management) but there is no financial reporting, regulatory, or compliance language despite Mollie being a payments company.

**collaboration_width:** 4 — named teams: sales; customer success; marketing; partnerships

**data_team_maturity:** mid — The domain is explicitly described as actively growing and being rebuilt, with named tools (HubSpot, Omni, Looker, Tableau) in responsibilities, indicating a mid-stage, maturing function rather than early or fully mature.

**jd_authorship:** hiring_manager — Bullets name specific tools and precise application context (HubSpot data models, Omni, CSM/Merchant Sales domains), letting the reader understand what the person does day to day.

**stakeholder_orientation:** commercial — The explicit audience is sales, customer success, marketing, and partnerships — all commercial/GTM functions.

**autonomy_level:** mixed — The role combines strategic ownership of the GTM reporting domain ("own reporting", "shape how analytics is delivered") with an execution-support function for team projects, giving a mixed autonomy profile.

**greenfield_vs_fix:** mixed — The domain is being rebuilt from a prior reactive state while the candidate also owns and maintains existing dashboards, giving a mixed greenfield/fix signal.

**urgency:** standard — No urgency signals present.

**work_arrangement:** hybrid — Remote/ Hybrid: Hybrid
...
**ats_job_id:** e6f792da-14d3-4a60-8e33-96700f00006f
