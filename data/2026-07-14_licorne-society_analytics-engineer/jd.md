# Analytics Engineer — Licorne Society
...
*3-run LLM consistency check: `../../analysis/jd_traces/2026-07-14_licorne-society_analytics-engineer.md` (generated by `classify_jds.py`, may not exist yet)*

**velocity_vs_rigour:** mixed — JD balances clean infrastructure (rigour) with rapid execution and AI-native culture (velocity).

**domain_risk:** moderate — Moderate risk: impacts revenue/GTM but not financial reporting or compliance-critical.

**collaboration_width:** 4 — named teams: Sales; Marketing; Finance; Product

**data_team_maturity:** early — Early maturity—first full-time data hire, though infrastructure is clean; role is to establish data team.

**jd_authorship:** hiring_manager — Specific technical responsibilities (dbt scaling, data layers, automation) indicate hiring manager authorship.

**stakeholder_orientation:** commercial — Focus on revenue operations and sales enablement (B2B data enrichment for commercial teams).

**autonomy_level:** strategic — Strategic role—you create the data team, set direction, and drive complex business analyses.

**greenfield_vs_fix:** greenfield — Greenfield—first data hire creating the function, though infrastructure foundation exists.

**urgency:** standard — No urgency signals present.

**language_gate:** hard — "French (hard requirement—job posted entirely in French, Parisian headquarters)"
...
**loss_aversion:** Zéro chaos, que de l'impact — role emphasizes clean data infrastructure as a competitive advantage.
