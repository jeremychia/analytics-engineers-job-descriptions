# Analytics Engineer — Blinq

**URL:** https://jobs.lever.co/blinq/c514cc4d-1938-44a8-aeee-fa01c24ab7d6?lever-source%5B%5D=jobs.touringcapital.com
...
*3-run LLM consistency check: `../../analysis/jd_traces/2026-07-28_blinq_analytics-engineer.md` (generated by `classify_jds.py`, may not exist yet)*

**velocity_vs_rigour:** mixed — Rigour signals (data quality, testing, documentation, lineage, monitoring, ownership) sit alongside repeated velocity phrasing ('move quickly', 'high-growth SaaS', 'comfort when priorities change'), giving parity.

**domain_risk:** moderate — A consumer/B2B SaaS app where analytics inform product, growth, and revenue decisions without regulatory or financial-reporting stakes, so moderate.

**collaboration_width:** 5 — named teams: Product; Growth; Revenue; Finance; Engineering

**data_team_maturity:** early — The role owns and builds the analytics layer and canonical metrics from the ground up at a high-growth startup, with 'raise the bar... as the company scales' signaling the function is still being established.

**jd_authorship:** hiring_manager — Specific tools, techniques, and analytical methods (dbt, ELT, funnel/cohort/retention analysis, A/B testing) make clear what the candidate does day to day.

**stakeholder_orientation:** mixed — Five distinct stakeholder groups spanning product, commercial, and finance are named with comparable weight, giving genuinely mixed orientation.

**autonomy_level:** mixed — The role combines strategic ownership of the analytics layer and standards-setting with execution work in service of stakeholder requests, landing as mixed.

**ai_role:** none — Despite Blinq being described as an 'AI-native company' and 'AI contacts app,' no AI skill or tool usage is expected of the Analytics Engineer candidate specifically.

**testing_framing:** responsibility — Testing and data quality are framed as an owned responsibility the candidate improves and is accountable for, not merely a listed skill.

**loss_aversion_framing:** moderate — Moderate: reliability, trust, and monitoring are emphasized but framed around operational data trust rather than compliance or regulatory exposure.

**greenfield_vs_fix:** greenfield — The dominant verb signal is building new foundational data models, metrics, and self-serve infrastructure from a growing but young analytics function.

**urgency:** standard — No urgency signals present.

**work_arrangement:** hybrid — Three days a week in the office, two wherever works for you.
...
**ats_job_id:** c514cc4d-1938-44a8-aeee-fa01c24ab7d6

**loss_aversion:** "Improve data quality and trust through testing, documentation, lineage, monitoring, and clear ownership" — reflects concern for data trustworthiness rather than compliance.
